    ...
    <main className="cf">
      ...
      <div className="cf-ie">
        <div className="cf-card">
          ...
          {r.ingresos.leadtion > 0 && <div className="cf-li"><span>Leadtion (membresías) <small style={{ color: "var(--faint)" }}>no facturadas</small></span><b>{usd2(r.ingresos.leadtion)}</b></div>}
